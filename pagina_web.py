...
"""
 ...
 # Creamos un cuadro de selección en la página de gráficos
    ...
    texto_3 = "¿Te sientes preparado para una trivia y poner a prueba tus conocimientos sobre Haaland? Si es así, pulsa el botón de abajo y prepárate para responder algunas preguntas basadas en la información vista.________________________________________________________________________________________"
